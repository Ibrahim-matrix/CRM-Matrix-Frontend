...
const AddImage: React.FC = () => {
  ...
  // const onSubmit = (formData: WhatsAppImage) => {
  //   // Handle form submission by dispatching the postData action and retrieving city data
  //   dispatch(postData({...formData, type : '2' }, endpoint, navigate, toast)).then(() => {
  ...
  const onSubmit = (formData: WhatsAppImage) => {
    ...
    const typeData = {
      type: '2', // Update with the desired type
    };
